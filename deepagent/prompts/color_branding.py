...
قوانین:
- اگر در «مشخصات محصول» یک نام برند/پروژه مشخص ذکر شده (مثلاً در عنوان یا ابتدای متن)، همان نام را
  دقیقاً و بدون تغییر به‌عنوان brand_name برگردان؛ نام جدید اختراع نکن یا آن را تغییر نده.
- فقط وقتی هیچ نامی در مشخصات محصول مشخص نشده، خودت یک نام مناسب پیشنهاد بده."""
